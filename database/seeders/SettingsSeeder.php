...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'widgets.stats_enabled', 'value' => '["today","max_wind","precipitation","aqi","uv","earthquakes","next_rain","advisory","vs_yesterday","best_time"]', 'type' => 'json', 'group' => 'widgets', 'description' => 'Enabled Quick Stats tiles on the dashboard'],
